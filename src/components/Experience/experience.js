  ...
  return (
    <section id="exp">
      <span className="expTitle">
        Education <span className="and">& </span>Experience
      </span>
      <span className="expDesc">
        I completed my B.Tech in Computer Science and Engineering, and I have
      ...
      <div className="expBars">
        <div className="expBar">
          ...
          <div className="expBarText">
            ...
            <p>
              {" "}
              I completed my graduation in CSE with an aggregate CGPA of 6.72.
            </p>
          </div>
        </div>
      </div>
